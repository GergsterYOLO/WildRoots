...
if (global.nbvisible) {
    ...
    if (id == o_plant1_part4) {
        global.plant1_part4_pos = [center_x - 410, center_y];
    }
    ...
    if (mouse_check_button_pressed(mb_left) && position_meeting(mouse_x, mouse_y, id)) {
        ...
        //update map
        if (object_index == o_plant1_part4) {
			phlox_map[? "aspects_discovered"][3] = true;
        }
        //update plant entry visibility
        var entry_instance = instance_find(o_plant1_part4_entry, 0);
